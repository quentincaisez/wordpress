 ...
 */
class instablog_Post_Dropdown extends WP_Customize_Control
{
    private $posts = false;
        ...
        if(!empty($this->posts))
        {
            ?>
                <label>
                    ...
                    <option value="none" <?php if ( get_theme_mod($this->id) == 'none' ) echo 'selected="selected"'; ?>><?php __('None', 'instablog'); ?>--Select Post -- </option>
